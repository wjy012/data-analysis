...
export function buildExportBody(type) {
  ...
  if (type === 'total') {
    params.paramBlock.data.orderApproveTimeSection = getDateRange('year')
    ...
    params.paramBlock.data[type] = getDateRange('month')
